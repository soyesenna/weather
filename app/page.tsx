...
import { demoGauges, demoPumps, demoShelters } from '@/packages/risk/demo-data';
...
export default async function Home() {
  ...
  return <div className="container">
    ...
    <main>
      ...
      <FloodDashboard cells={cells} shelters={demoShelters} pumps={demoPumps} gauges={demoGauges} reports={reports} />
